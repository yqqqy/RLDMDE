...
// void rot_rastrigin_func (double *, double *, int, double *, double *, int);  rotated rastrigin function
...
// void rot_schwefel_func (double *, double *, int, double *, double *, int);  rotated schwefel function
...
// void rot_bi_rastrigin_func(double *, double *, int, double *, double *, int);  rotated Bi_rastrigin Function
...
//   mexFunction (2, plhs[], 2, prhs[]); //plhs contains 2 elements, the return value; prhs contains two elements, first is parameter array, second is seq of dest function. 
void mexFunction (int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[]) 
{
	...
	n = mxGetM (prhs[0]);   // get the row number;
	...
	m = mxGetN (prhs[0]);   // get column number;
	x = mxGetPr (prhs[0]);  // get matrix entry address
...
void test_func(double *x, double *f, int nx, int mx,int func_num) // nx: row, mx: column  
{
	int cf_num=10,i;
	if (ini_flag==1)
	{
